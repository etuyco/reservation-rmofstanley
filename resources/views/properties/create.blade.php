            ...
            <div class="card-body">
                <form action="{{ route('admin.properties.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('max_daily_booking_days') is-invalid @enderror" id="max_daily_booking_days" name="max_daily_booking_days" value="{{ old('max_daily_booking_days', 7) }}" min="1" max="365">
